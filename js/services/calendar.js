...
export function openGoogleCalendar({ guestName = "Bạn", chosenTime = "15:00" }) {
  ...
  const details = `Thân mời bạn ${guestName} đến tham dự Lễ Tốt Nghiệp của Trần Tùng Lâm (Tân Cử Nhân)!\n\nKhung giờ hẹn đón tiếp: ${chosenTime} - Chủ Nhật, 27/09/2026.\nĐịa điểm: ${EVENT_CONFIG.location}.\nRất mong được đón tiếp và chụp ảnh kỷ niệm cùng bạn! 💕✨`;
...
export function downloadAppleCalendarIcs({ guestName = "Bạn", chosenTime = "15:00" }) {
  ...
  const description = `Thân mời bạn ${guestName} đến tham dự Lễ Tốt Nghiệp của Trần Tùng Lâm (Tân Cử Nhân)!\\nKhung giờ hẹn: ${chosenTime} - Chủ Nhật, 27/09/2026.\\nĐịa điểm: ${EVENT_CONFIG.location}.`;
